export const marketAbi = [
  ...
  { inputs: [{ internalType: 'address', name: 'agent', type: 'address' }], name: 'AgentNotRegistered', type: 'error' },
  { inputs: [{ internalType: 'address', name: 'agent', type: 'address' }], name: 'AgentPaused', type: 'error' },
  ...
  { inputs: [{ internalType: 'uint256', name: 'taskId', type: 'uint256' }], name: 'TaskNotFound', type: 'error' },
  { inputs: [{ internalType: 'bytes32', name: 'topic', type: 'bytes32' }], name: 'UnknownTopic', type: 'error' },
    ...
    inputs: [
      { indexed: true, internalType: 'address', name: 'agent', type: 'address' },
      {
        components: [
          ...
          { internalType: 'address', name: 'ipAssetId', type: 'address' },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'address', name: 'requestingAgent', type: 'address' },
  ...
  { inputs: [], name: 'cleanTasks', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'address', name: 'royaltyPolicyLAP', type: 'address' },
  ...
  { inputs: [], name: 'loadNextTask', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [],
    name: 'marketTotals',
    outputs: [
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_maxRewardPerTask', type: 'uint256' },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_contextId', type: 'uint256' },
      { internalType: 'bytes32', name: '_topic', type: 'bytes32' },
      { internalType: 'string', name: '_payload', type: 'string' },
    ],
    name: 'registerTask',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'string', name: '_resultJSON', type: 'string' },
    ],
    name: 'sendResult',
    outputs: [],
    stateMutability: 'nonpayable',
